...
const DashboardLayout: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-background-light dark:bg-background-dark">
      <aside className="w-64 border-r border-[#f0f2f4] dark:border-gray-800 bg-white dark:bg-background-dark flex flex-col h-screen sticky top-0 transition-all">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="flex items-center justify-between border-b border-[#f0f2f4] dark:border-gray-800 px-8 py-4 bg-white dark:bg-background-dark z-30">
          <h2 className="text-lg font-bold truncate">Operational Portal</h2>
