...
const InventoryPage: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="flex flex-col md:flex-row md:flex-wrap justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h2 className="text-2xl md:text-3xl font-black tracking-tight text-[#111318] dark:text-white">Fleet Inventory</h2>
          <p className="text-[#616f89] text-sm md:text-base font-medium">Global fleet status, location, and maintenance tracking.</p>
        </div>
        <Link
          to="/assets/add"
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="relative w-full lg:w-auto">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-800 border-none rounded-lg text-xs w-full lg:w-64 focus:ring-1 focus:ring-primary transition-all"
              />
            </div>
          </div>
