...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-black tracking-tight text-[#111318] dark:text-white">System Settings</h1>
        <p className="text-[#616f89] text-base">Central control for organization preferences and user management.</p>
      </div>
      ...
      <div className="mt-12 p-8 rounded-xl bg-gray-50 dark:bg-gray-900 border border-[#f0f2f4] dark:border-gray-800">
