  ...
  return (
    <div className="p-8 max-w-[1400px] mx-auto animate-in fade-in duration-500">
      <div className="mb-8 flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-[#111318] dark:text-white">Operational Dashboard</h1>
          <p className="text-[#616f89] text-base">Overview of your enterprise rental fleet and active operations.</p>
        </div>
        <div className="flex gap-2">
           <button className="px-4 py-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg text-xs font-bold hover:bg-gray-50 transition-all flex items-center gap-2">
