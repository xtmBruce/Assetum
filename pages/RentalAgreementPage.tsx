  ...
  return (
    <div className="p-8 max-w-[1200px] mx-auto animate-in fade-in duration-300">
      <div className="flex items-center justify-between mb-10">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-white">New Rental Agreement</h1>
          <p className="text-[#616f89] dark:text-gray-400 mt-1 font-medium">Step {step} of 2: {step === 1 ? 'Logistics & Client Data' : 'Valuation & Payment Strategy'}</p>
        </div>
